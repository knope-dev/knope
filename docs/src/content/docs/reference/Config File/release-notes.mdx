...
This variable requires configuring [`[github]`](/reference/config-file/github). Knope will fetch the
...
If you don't use these variables, Knope makes no API calls.
...
This variable requires configuring [`[github]`](/reference/config-file/github). Knope will look up the
