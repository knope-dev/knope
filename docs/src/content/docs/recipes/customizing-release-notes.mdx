...
The first template is used when both the PR number and author login are available.
...
If you don't use these variables, no API calls are made and no token is needed.
