...
use crate::{changes::Change, release_notes::Sections, semver::Version};
...
pub fn sections_to_markdown<T: Iterator<Item = Section>>(
...
impl Release {
    ...
    /// # Errors
    ///
    /// If the current date cannot be formatted
    pub fn new(
        version: &Version,
        changes: &[Change],
